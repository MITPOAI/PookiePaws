...
func main() {
	addr := flag.String("addr", "127.0.0.1:18800", "HTTP listen address")
	homeOverride := flag.String("home", "", "override runtime home")
	flag.Parse()

	runtimeRoot, workspaceRoot, err := resolveRoots(*homeOverride)
	if err != nil {
...
func resolveRoots(homeOverride string) (string, string, error) {
	if homeOverride != "" {
